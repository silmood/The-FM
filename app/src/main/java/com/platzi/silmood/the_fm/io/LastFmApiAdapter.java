...
public class LastFmApiAdapter {
    ...
    public static void getHypedArtists(Callback<HypedArtistResponse> serverCallback){
        getApiService().getHypedArtists(obtainApiKey(), serverCallback);
    }

    public static void getTopArtists(Callback<TopArtistsResponse> serverCallback){
        getApiService().getTopArtists(obtainApiKey(), serverCallback);
    }
